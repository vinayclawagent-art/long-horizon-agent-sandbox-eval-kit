...
status: active
package: "[[Long-Horizon Agent Sandbox Eval Kit]]"
github_repo: "https://github.com/vinayclawagent-art/long-horizon-agent-sandbox-eval-kit"
cadence: nightly
last_improved: 2026-06-21
next_focus: "Run the next real long-horizon sandbox trial, fill the evidence packet and post-trial debrief, grade proof with the Sandbox Evidence Quality Rubric, then patch README/prototype/skill claims only where evidence supports them."
tags: [improvement-loop, x-artifact-factory, agent-workflows]
---

# Long-Horizon Agent Sandbox Eval Kit Loop
